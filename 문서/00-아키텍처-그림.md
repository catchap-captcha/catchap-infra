...
🔶 옛 서버 내리기       ✅정지(0811) · ✅노출 차단(0812) · ⬜삭제(반납)만 남음
                       ✅①옛 백엔드 정지 →✅②3306 차단(퍼블릭IP 해제+규칙 삭제)
                       →⬜③서버 삭제  ⚠️비밀번호가 git 이력에 남아 있음
                       ⚠️옛 GPU 는 sw님 폴더(466건)가 있어 ★따로 판단
...
⬜ SSL 인증서           2026-10-20 만료 · 갱신 수동
⬜ VM3 · VM4            비어 있음 · ★"옛 서버 없앨 때 반납" (0806 결정)
